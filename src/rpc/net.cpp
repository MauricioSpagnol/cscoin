...
UniValue getpeerinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/CSCoin:x.y.z[-v]/\",  (string) The string version\n"
...
UniValue getaddednodeinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:16125\",  (string) The CS server host and port\n"
...
UniValue getdeprecationinfo(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 0 || chainparams.NetworkIDString() != "main")
        throw runtime_error(
            ...
            "  \"subversion\": \"/CSCoin:x.y.z[-v]/\",     (string) the server subversion string\n"

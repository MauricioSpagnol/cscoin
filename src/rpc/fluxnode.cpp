...
UniValue viewdeterministicfluxnodelist(const UniValue& params, bool fHelp, string cmdname)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
                ...
                "    \"tier\": \"type\",                      (string) Tier (PROTON/ELETRON/NEUTRON/FOTON)\n"
                "    \"payment_address\": \"addr\",           (string) CSNode payment address\n"
...
UniValue getfluxnodecount (const UniValue& params, bool fHelp, string cmdname)
{
    ...
    words.insert(make_pair(0, make_pair("proton-enabled",  "proton-enabled")));
    words.insert(make_pair(1, make_pair("eletron-enabled", "eletron-enabled")));
    words.insert(make_pair(2, make_pair("neutron-enabled", "neutron-enabled")));
    words.insert(make_pair(3, make_pair("foton-enabled",   "foton-enabled")));

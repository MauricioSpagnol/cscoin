...
//            }
            ...
            for (unsigned int i = 0; i < pcoin->vout.size(); i++) {
                ...
                if (nCoinType == ONLY_PROTON) {
                    if (nTier == PROTON)  found = true;
                } else if (nCoinType == ONLY_ELETRON) {
                    if (nTier == ELETRON) found = true;
                } else if (nCoinType == ONLY_NEUTRON) {
                    if (nTier == NEUTRON) found = true;
                } else if (nCoinType == ONLY_FOTON) {
                    if (nTier == FOTON)   found = true;

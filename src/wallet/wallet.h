...
enum AvailableCoinsType {
    ALL_COINS    = 1,
    ONLY_PROTON  = 2,   // CSNode PROTON collateral outputs (10,000 CS)
    ONLY_ELETRON = 3,   // CSNode ELETRON collateral outputs (25,000 CS)
    ONLY_NEUTRON = 4,   // CSNode NEUTRON collateral outputs (100,000 CS)
    ONLY_FOTON   = 6,   // CSNode FOTON collateral outputs (500,000 CS)
    ALL_FLUXNODE = 5,
    // Legacy aliases
    ONLY_CUMULUS = ONLY_PROTON,
    ONLY_NIMBUS  = ONLY_ELETRON,
    ONLY_STRATUS = ONLY_NEUTRON,
};

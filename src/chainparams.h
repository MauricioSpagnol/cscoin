...
public:
    ...
    int64_t GetDevFundStartHeight() const { return nDevFundStartHeight; }
    CAmount GetDevFundAmount() const { return nDevFundAmount; }
    ...
    int64_t GetMarketingFundInterval() const { return nMarketingFundInterval; }
    int GetMarketingFundMaxTimes() const { return nMarketingFundMaxTimes; }
...
protected:
   ...
   // unsigned long eh_epoch_2_startblock = 0;		// Moved to consensus
    ...
    int64_t nDevFundStartHeight;
    CAmount nDevFundAmount;
    int64_t nDevFundInterval;
    int64_t nDevFundMaxTimes;

    std::string strMarketingFundAddress;
    int64_t nMarketingFundStartHeight;
    CAmount nMarketingFundAmount;
    int64_t nMarketingFundInterval;
    int64_t nMarketingFundMaxTimes;

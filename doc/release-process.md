...
- Run the [Gitian deterministic build environment](https://github.com/MauricioSpagnol/cs-gitian)
- Compare the uploaded [build manifests on gitian.sigs](https://github.com/MauricioSpagnol/gitian.sigs)
- If all is well, the DevOps engineer will build the Debian packages and update the
  [packages.cscoin.io package repository](https://packages.cscoin.io).

## Add release notes to GitHub

- Go to the [GitHub tags page](https://github.com/MauricioSpagnol/cscoin/tags).
...
This also means updating [the translations](https://github.com/MauricioSpagnol/cscoin-docs).

...
router", implementing the cs coin wire protocol and relay, making
...
The ZeroMQ feature in CS Coin requires ZeroMQ API version 4.x or
...
For instance:
    ...
    $ csd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/csd.tx.raw
...
From the perspective of csd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into csd directly. Furthermore, no information is
...
using. Csd appends an up-counting sequence number to each
